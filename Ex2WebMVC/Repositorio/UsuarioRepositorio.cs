...
namespace Ex2WebMVC.Repositorio {
    public class UsuarioRepositorio {
        ...
        public List<UsuarioModel> Listar () {
            ...
            string[] linhas = File.ReadAllLines ("usuarios.csv"); //criar um array com as linhas
        ...
        public UsuarioModel EditarUsuario(UsuarioModel usuario){
             ...
             for (int i = 0; i < linhas.Length; i++)
             {
                 ...
                 //Vamos verificar se o id do usuário é igual ao da linha
